...
RAM_stressors <- read.csv("data/raw_data/vegetation_data/FOA_veg_data/RAM_stressors_2015_2025.csv") %>%
  as_tibble()

vertical_complexity <- read.csv("data/raw_data/vegetation_data/FOA_veg_data/vertical_complexity_2015_2025.csv") %>%
  as_tibble()
